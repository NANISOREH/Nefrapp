    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <%--								<form action="${azione }">--%>
                <%--									<h2 class="h4 mb-4 text-gray-500"--%>
                <%--										style="display: inline; margin-right: 150px;">--%>
                <%--										Nome: <span class="h3 mb-4 text-gray-800">${nome}</span>--%>
                <%--									</h2>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500" style="display: inline">--%>
                <%--										Cognome: <span class="h3 mb-4 text-gray-800">${cognome}</span>--%>
                <%--									</h2>--%>
                <%--									<br> <br>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500">--%>
                <%--										Sesso: <span class="h3 mb-4 text-gray-800">${sesso}</span>--%>
                <%--									</h2>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500">--%>
                <%--										Codice fiscale: <span class="h3 mb-4 text-gray-800">${codiceFiscale}</span>--%>
                <%--									</h2>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500">--%>
                <%--										Email: <span class="h3 mb-4 text-gray-800">${email}</span>--%>
                <%--									</h2>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500"--%>
                <%--										style="display: inline; margin-right: 150px;">--%>
                <%--										Data di nascita: <span class="h3 mb-4 text-gray-800">${dataDiNascita}</span>--%>
                <%--									</h2>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500" style="display: inline">--%>
                <%--										Luogo di nascita: <span class="h3 mb-4 text-gray-800">${luogoDiNascita}</span>--%>
                <%--									</h2>--%>
                <%--									<br> <br>--%>

                <%--									<h2 class="h4 mb-4 text-gray-500">--%>
                <%--										Residenza: <span class="h3 mb-4 text-gray-800">${residenza}</span>--%>
                <%--									</h2>--%>
                ...
                <%--													<span class="h3 mb-4 text-gray-800">${item.nome}--%>
                <%--														${item.cognome} </span>--%>
                <%--												</c:if>--%>
                <%--												<c:if test="${loop.index gt 0}">--%>
                <%--													<h3 class="h3 mb-4 text-gray-800"--%>
                <%--														style="margin-left: 10.6%; line-height: 1px;">${item.nome}--%>
                <%--														${item.cognome}</h3>--%>
                <%--												</c:if>--%>
                <%--											</c:forEach>--%>
                <%--										</h2>--%>
                ...
                <%--												<c:if test="${loop.index gt 0}">--%>
                <%--													<h3 class="h3 mb-4 text-gray-800"--%>
                <%--														style="margin-left: 78px; line-height: 1px;">${item.nome}--%>
                <%--														${item.cognome}</h3>--%>
                <%--												</c:if>--%>
                <%--											</c:forEach>--%>
                <%--										</h2>--%>
                ...
                <%--									<c:if test="${isPaziente}">--%>
                <%--										<button type="button" class="btn btn-warning"--%>
                <%--											data-toggle="modal" data-target="#disattivaModal"--%>
                <%--											style="margin-left: 70%;">Disattiva account</button>--%>
                <%--									</c:if>--%>
                <%--									<button type="submit" class="btn btn-primary"--%>
                <%--										style="float: right;">Modifica account</button>--%>
                <%--								</form>--%>
                <%--							</div>--%>
                <%--						</div>--%>
                <%--					</div>--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Seleziona "Disattiva" qui sotto se sei
                sicuro di voler disattivare il tuo account.
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Seleziona "Elimina" qui sotto se sei
                sicuro di voler eliminare il tuo account.
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button"
                        data-dismiss="modal">Annulla
